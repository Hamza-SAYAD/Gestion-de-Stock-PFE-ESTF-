...
<body>
<br><br><h1 align="center" ><font COLOR= "white">Coût de gestion de stock</font></h1>
	<br><br>
	<div align="center">
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST"  >
	
<strong ><font COLOR= "white">Nom produit</font>   </strong><br><br>
...
if($exer){
   print'<div style="overflow-x:auto;">';
	...
	print'<tr><th>Nom produit</th><th>Prix unitaire</th></th><th>Coût de passation</th><th>Taux de possession</th><th>Quantite anuelle</th><th>Coût de gestion du stock</th></tr>';
	...
	print'</td>';
	$cgs = number_format(sqrt(2*$cpa*$D*$prix*$tp)  ,0,'','');
